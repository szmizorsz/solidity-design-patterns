...
contract VulnerableBankWithGuard is ReentrancyGuard {
...
contract MaliciousContractAgainsGuards {
    VulnerableBankWithGuard public vulnerableBank;
    address public owner;

    constructor(address _vulnerableBank) {
        vulnerableBank = VulnerableBankWithGuard(_vulnerableBank);
        owner = msg.sender;
    }
